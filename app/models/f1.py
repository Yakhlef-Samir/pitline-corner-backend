...
class Race(Base):
    ...
    drivers: Mapped[list["RaceDriver"]] = relationship(
        "RaceDriver", back_populates="race"
    )
    ...
    simulations: Mapped[list["Simulation"]] = relationship(
        "Simulation", back_populates="race"
    )
...
class Driver(Base):
    ...
    # Relationships
    races: Mapped[list["RaceDriver"]] = relationship(
        "RaceDriver", back_populates="driver"
    )
    lap_data: Mapped[list["LapData"]] = relationship("LapData", back_populates="driver")
    pit_stops: Mapped[list["PitStop"]] = relationship(
        "PitStop", back_populates="driver"
    )
    simulations: Mapped[list["Simulation"]] = relationship(
        "Simulation", back_populates="driver"
    )
...
class LapData(Base):
    ...
    race_id: Mapped[int] = mapped_column(
        ForeignKey("races.id"), nullable=False, index=True
    )
...
class PitStop(Base):
    ...
    tire_compound_before: Mapped[Optional[str]] = mapped_column(
